...
namespace ERP.Ticketing.HttpApi.Migrations
{
    ...
    [Migration("20230329161337_AddTicketDepartmentHistoryMigration")]
    partial class AddTicketDepartmentHistoryMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Tenants.Tenant", b =>
                {
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Tenants.TenantUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Ticketing.TicketDepartmentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TicketDepartmentHistories");
                });
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Users.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Users.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Users.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Departments.Department", b =>
                {
                    ...
                    b.HasOne("ERP.Ticketing.HttpApi.Features.Tenants.Tenant", "Tenant")
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Tenants.TenantUser", b =>
                {
                    ...
                    b.HasOne("ERP.Ticketing.HttpApi.Features.Users.User", null)
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Users.User", b =>
                {
                    ...
                    b.HasOne("ERP.Ticketing.HttpApi.Features.Users.Role", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("ERP.Ticketing.HttpApi.Features.Users.UserRole", b =>
                {
                    b.HasOne("ERP.Ticketing.HttpApi.Features.Users.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("ERP.Ticketing.HttpApi.Features.Users.Permission", null)
                        .WithMany()
